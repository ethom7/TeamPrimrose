...
public class EmployeesRS {
    ...
    public Response create(@FormParam("firstName") String firstName, @FormParam("middleName") String middleName,
                           ...
                           @FormParam("socialSecurityNumber") Integer socialSecurityNumber, @FormParam("dob") String dob) {
        ...
        if (in != null) {
            try {
                ...
                while ((record = reader.readLine()) != null) {
                    ...
                    addEmployee(parts[0], parts[1], parts[2], Integer.getInteger(parts[3]), parts[4]);
                }
            }
            catch (Exception e) {
    ...
    private int addEmployee(String firstName, String middleName, String lastName, Integer socialSecurityNumber, String dob) {
