...
public class MongoConnector {
    ...
    private final String ipAddress = "192.168.1.211";  // this is to be updated to ip address of the db
    private final String port = "27017";
    private final String authDB = "user-data";  // authorization collection db
